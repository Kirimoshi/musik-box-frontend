...
describe("Clear Button Functionality", ()=>{
    ...
    test("Clear email button should clear the email field",()=>{  
        ...
        fireEvent.change(emailInput,{target:{value:"saiprakash845@gmail.com"}})
    ...
    test("Clear confirm password button should clear the confirm password field",()=>{  
        ...
        const confirmPasswordInputClearElement=screen.getByTestId('confirmPasswordClear');
...
describe("Sign Up Validations", ()=>{
    ...
    test("Nickname should be minimum of three characters",()=>{  
        ...
        expect(nicknameInputErrorElement.innerHTML).toBe('Please enter the nickname that includes between 3 and 50 characters.');
    })
    ...
    test("Email Should be without any spaces and special characters",()=>{  
        ...
        const emailInput=screen.getByTestId("email");
        fireEvent.change(emailInput,{target:{value:"sai prakash845@gmail.com"}})
        const submitButtonElement=screen.getByRole("button",{
            name: "Sign Up",
        });
        fireEvent.click(submitButtonElement);
        const emailInputErrorElement=screen.getByTestId('emailError');
        expect(emailInputErrorElement.innerHTML).toBe('Please enter a valid email address without any spaces or special characters.');
    }) 
    ...
    test("Password should contain atleast one special character",()=>{  
        ...
        expect(passwordInputErrorElement.innerHTML).toBe('Please enter a password that includes at least one special character.');
    }) 
    ...
    test("Password should contain atleast one lower case letter",()=>{  
        ...
        fireEvent.click(submitButtonElement);
        const passwordInputErrorElement=screen.getByTestId('passwordError');
        expect(passwordInputErrorElement.innerHTML).toBe('Please enter a password that includes at least one lowercase letter.');
    }) 
    ...
    test("Password should contain atleast one upper case letter",()=>{  
        ...
        fireEvent.click(submitButtonElement);
        const passwordInputErrorElement=screen.getByTestId('passwordError');
        expect(passwordInputErrorElement.innerHTML).toBe('Please enter a password that includes at least one uppercase letter.');
    }) 
    ...
    test("Password should contain atleast one digit",()=>{  
        ...
        fireEvent.click(submitButtonElement);
        const passwordInputErrorElement=screen.getByTestId('passwordError');
        expect(passwordInputErrorElement.innerHTML).toBe('Please enter a password that includes at least one number.');
    }) 
    test("Confirm Password should be same as password", ()=>{
        ...
        fireEvent.click(submitButtonElement);
        const confirmPasswordErrorElement=screen.getByTestId("confirmPasswordError");
        expect(confirmPasswordErrorElement.innerHTML).toBe('The passwords you entered do not match. Please try again.');
    })
})