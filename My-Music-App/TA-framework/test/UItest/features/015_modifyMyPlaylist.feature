...
Feature: EPMRDPEMAP-627 Modify My Playlist information
    ...
    Scenario: The user validates the Edit Playlist form data
        ...
        And "Edit Playlist Form Download Logo Button" is displayed on "myPlaylists" page
        And "myPlaylists" page "Edit Playlist Form" "Title" is: "Edit playlist"
    ...
    @Regression
    Scenario: The user verifying formats of logo
        Given the user clicks on the "myPlaylists" page "Playlist" "Menu" 1 element
        When the user clicks on the "myPlaylists" page "Edit Playlist" "Button" 1 element
        Then "Edit Playlist Form" is displayed on "myPlaylists" page
    ...
    Scenario: The user is able to edit playlist name
        ...
        And the user "Input" "Name" in the "myPlaylists" "Edit Playlist" as: "The most popular songs"
        And the user clicks on the "myPlaylists" page "Edit Playlist Form" "Submit Button"
    ...
    Scenario: The user is able to edit playlist description
        ...
        And the user clicks on the "myPlaylists" page "Edit Playlist Form" "Submit Button"
        And the user "Input" "Value" in the "myPlaylists" "Search Box" as: "The popular songs"
        And the user clicks on the "myPlaylists" page "Playlist" "Menu" 1 element
        And the user clicks on the "myPlaylists" page "Edit Playlist" "Button" 1 element
