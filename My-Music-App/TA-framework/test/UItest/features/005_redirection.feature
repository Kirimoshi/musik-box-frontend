...
Feature: EPMRDPEMAP-638 - Redirect Authenticated Users from the Sign In and Sign Up pages
  Scenario: Verify that the authenticated user redirects to the "home" page from "signIn" page
  ...
  Scenario: Verify that the authenticated user redirects to the "signUp" page from "home" page
    Given the user is on the "home" page
    Then the user storage data is not empty
